...
function Product(prod) {
    ...
    if (!productList) {
        try {
            ...
            console.log('The product can not be created!\n Product List, has not been found');
            throw new Error('The product can not be created!\n Product List, has not been found');
        }
    }
    /**
...
Order.prototype.setOrderInfo = function (orderDetails) {
    ...
    if (orderDetails.deliveryType) this.deliveryType = orderDetails.deliveryType;
...
var productList = []; // list of ll created products
