$(function () {
    ...
    function lupa(className) {
        var divImg = $('.' + className).filter(':first'); //div with small image
        var smallImg = divImg.find('img'); // small image

        // Creates new div, sets its width and height equal width and height of small image
        var divLargeImg = $('#large_img').width(divImg.width()).height(divImg.height());

        var largeImg = divLargeImg.find('img'); // large image
